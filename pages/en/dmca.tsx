...
export default function DMCA() {
  return (
    <>
      <Head>
        <title>Makima - DMCA</title>
        <meta name="DMCA" content="DMCA" />
        <meta property="og:title" content="DMCA" />
        <meta
          property="og:description"
          content="Makima.xyz is committed to respecting the intellectual
          ...
          <div className="px-5 lg:px-0 lg:w-[75%] text-2xl gap-7 flex flex-col my-[10rem]">
            ...
            <div className="flex flex-col gap-10">
              <div className="flex flex-col gap-3 text-[#cdcdcd]">
                <p>
                  Makima.xyz is committed to respecting the intellectual
                  property rights of others and complying with the Digital
              ...
              <p className="text-[#cdcdcd]">
                None of the files listed on Makima.xyz are hosted on our
                servers. All links point to content hosted on third-party
                websites. Makima.xyz does not accept responsibility for content
                ...
                <a
                  href="mailto:contact@Makima.xyz?subject=[Makima]%20-%20Your%20Subject"
